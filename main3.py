...
smile_x,smile_y = (face_x + 10,face_y - 10)
eye1_x,eye1_y = (face_x - 55,face_y + 55) 
eye2_x,eye2_y = (face_x + 55,face_y + 55)
catch1_x,catch1_y = (face_x - 55,face_y + 55) 
catch2_x,catch2_y = (face_x + 55,face_y + 55) 
...
arcade.draw_circle_filled(catch1_x,catch1_y,2,open_color.gray_2)
arcade.draw_circle_filled(catch2_x,catch2_y,2,open_color.gray_2)

#(x,y,width,height,color,start_degrees,end_degrees,border_thickness)
arcade.draw_arc_outline(smile_x,300,smile_y,400,15,25,open_color.black,190,350,4)
