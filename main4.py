...
for x in range(300,450,150):
        #start at 100, go to 599, counting by 150
        for y in range(400,300,450):
                face_x,face_y = (x,y)
                smile_x,smile_y = (face_x + 450,face_y - 450)
                eye1_x,eye1_y = (face_x - 150,face_y + 100) 
                eye2_x,eye2_y = (face_x + 300,face_y + 300)
                catch1_x,catch1_y = (face_x - 150,face_y + 100) 
                catch2_x,catch2_y = (face_x + 150,face_y + 100) 
